      ...
      <div class="container">
			...
			while ($row = mysqli_fetch_array($result)){
				 echo '<tr>
						...
						{
              echo '<td><a class="top" href="includes/assigned.inc.php?id='.$row['content_id'].'&u=c">Assigned</a>
              <br> or <br><a href="" class="top"  data-toggle="modal" data-target="#deletemodal'.$row['content_id'].'" >Delete</a>
              </td>
							<td>Not Assigned</td>';
						}	
						else
						{
							...
							if($check['soa_paid']==0)
							{
                echo'<td><a class="top" href="includes/paid.inc.php?id='.$row['content_id'].'&u=c">Paid</a>
                <br> or <br><a href="" class="top"  data-toggle="modal" data-target="#deletemodal'.$row['content_id'].'" >Delete</a>
                </td>
								<td>Not Paid</td>';
							}
							else
							{
								...
								{
                  echo '<td><a class="top" href="includes/written.inc.php?id='.$row['content_id'].'&u=c">Written</a>
                  <br> or <br><a href="" class="top"  data-toggle="modal" data-target="#deletemodal'.$row['content_id'].'" >Delete</a>
                  </td>
									<td>Not Written</td>';
								}
								else
								{
									...
									{
                    echo '<td><a class="top" href="includes/complete.inc.php?id='.$row['content_id'].'&u=c">Completed</a>
                    <br> or <br><a href="" class="top"  data-toggle="modal" data-target="#deletemodal'.$row['content_id'].'" >Delete</a>
                    </td>
										<td>Not Completed</td>';
									}
									else
									{
										echo '
                    <td>Completed
                    <br> or <br><a href="" class="top"  data-toggle="modal" data-target="#deletemodal'.$row['content_id'].'" >Delete</a></td>
                    ';
									}
								}
							}
