        ...
        <th>Action</th>
			...
			while ($row = mysqli_fetch_array($result)){
				echo '<tr>
                        ...
                        <td>'.$row["email"].'</td>
                        <td>'.$row["address"].'</td>
            <td><a href="temp.php?u=vw&f='.$row["file"].'">'.$row["file"].'</a></td>
            <td><a href="" data-toggle="modal" data-target="#deletemodal'.$row['id'].'" >Delete</a></td>

            
					</tr> <div class="modal fade" id="deletemodal'.$row['id'].'" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <a href="includes/delete.inc.php?id='.$row['id'].'&u=w"><button type="button" class="btn btn-primary">Yes</button></a>
